...
sudo echo "deb http://deb.debian.org/debian $debian_version main contrib non-free non-free-firmware" >> $sources_list_path
sudo echo "deb http://deb.debian.org/debian $debian_version-updates main contrib non-free non-free-firmware" >> $sources_list_path
sudo echo "deb http://deb.debian.org/debian-security $debian_version-security main contrib non-free non-free-firmware" >> $sources_list_path
